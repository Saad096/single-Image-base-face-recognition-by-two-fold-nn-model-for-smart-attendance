# -*- coding: utf-8 -*-
"""
Created on Mon Nov 21 09:54:03 2022

@author: Muskan Computer
"""
import os
import zipfile
from tkinter import *
...
class Home_Page:
    def __init__(self, main_window):
        ...
        self.pil_img = Image.open("/home/saad/Fyp/title_image.png")
        ...
        self.pil_img1 = Image.open("/home/saad/Fyp/logo1.png")
    ...
    def Generate_attandance_sheet(self):
        ...
        ###############################################################################################
        classifier = load_model(filepath = r'/home/saad/.config/spyder-py3/classDataset/Custom_Train_Model/Xception_new_model.h5')
        ...
        def draw_test(name, pred, im):
            ...
            cv2.waitKey(0)
        self.faces = RetinaFace.extract_faces(img_path = "/home/saad/Pictures/Screenshot from 2023-01-01 12-42-07.png", align = True)
    ...
    def submit_sheet(self):
        ...
        book = load_workbook(r'/home/saad/Fyp/Attendance_Record.xlsx')
        with pd.ExcelWriter('/home/saad/Fyp/Attendance_Record.xlsx', engine='openpyxl') as writer:
                    if book is not None:
                        writer.book = book
    ...
    def view_Record(self):
        ...
        wb = load_workbook(r'/home/saad/Fyp/Attendance_Record.xlsx')
        dates = wb.sheetnames
    ...
    def view_sheets(self, options):
        ...
        df1 = pd.read_excel(r'/home/saad/Fyp/Attendance_Record.xlsx', sheetn)
    ...
    def Start_training(self):
        ...
        if(self.Trfolder is not None and self.Tsfolder is not None):
            ...
            folders = glob('/home/saad/.config/spyder-py3/classDataset/TrainData/*')
            x = Flatten()(X.output)
            ...
            model.save(r'/home/saad/.config/spyder-py3/classDataset/VGG16rained-model/Xception_new_model.h5')
        else:
            messagebox.showinfo("Sorry","Please Select train test directory")

if __name__ == "__main__":
    os.system("/home/saad/Desktop/Single Image based face recognition by two-fold NN Model for Smart Attendance/Splash_Screen.py")
    process1 = subprocess.Popen(["python", r"/home/saad/Desktop/Single Image based face recognition by two-fold NN Model for Smart Attendance/Splash_Screen.py"])
    process1.wait()
    window = Tk()
